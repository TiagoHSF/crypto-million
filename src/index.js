...
const bot = new node_telegram_bot_api_1.default(environment_1.environmentProd.botId, { polling: true });
const groupId = environment_1.environmentProd.telegramGroupId;
...
function sendMessageToTelegramGroup(msg) {
